    ...
    <div className="bg-image1 w-full flex lg:flex-row flex-col lg:p-20   p-10 items-center gap-7">
      <div className="flex-1 space-y-5 text-center lg:text-left">
        <h2 className="md:text-5xl text-3xl font-bold text-black ">
          Feel the Beat, Live the Melody: <span className="text-[#eb347a]">Where Music Meets Soul</span>
        </h2>
        ...
        <Link to={'/register'} className="btn bg-[#eb347a]">Register Now</Link>
      </div>

      <div className="flex-1 space-y-4 ">
        <p className="text-2xl font-semibold">{moment().format("MMMM Do YYYY")}</p>
